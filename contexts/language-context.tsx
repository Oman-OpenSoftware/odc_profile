...
const translations = {
  ar: {
    ...
    'mission.digital.description': 'ندفع المشهد الرقمي في عُمان عبر بيئة للحلول مبتكرة وأفضل الممارسات.',
  ...
  en: {
    ...
    'mission.digital.description': 'Leading the charge in modernizing Oman\'s digital landscape through an environment of innovative solutions and best practices.',
